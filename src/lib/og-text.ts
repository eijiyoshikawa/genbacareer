...
// the rendered OGP image. Map known offenders (confirmed via production runtime
// error logs) to ASCII or visually equivalent CJK glyphs that are already
// covered by the fonts used elsewhere on the page.
