  ...
  return (
    <>
      <button
        type="button"
        onClick={open}
        className="inline-flex items-center gap-1.5 border border-primary-400 text-primary-700 dark:text-primary-300 px-3 py-1.5 text-xs font-bold hover:bg-primary-50 dark:hover:bg-primary-900/30"
      >
      ...
      <dialog
        ref={dialogRef}
        className="max-w-lg w-full p-0 bg-white dark:bg-gray-900 backdrop:bg-black/50"
        aria-labelledby="review-dialog-title"
      >
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="flex items-start justify-between gap-3">
            <h2 id="review-dialog-title" className="text-lg font-bold text-gray-900 dark:text-gray-100">
              「{companyName}」に口コミを投稿
            </h2>
